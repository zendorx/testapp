...
struct  HelpURLAttribute_t4287019800  : public Attribute_t542643598
{
public:
...
public:
	inline static int32_t get_offset_of_m_Url_0() { return static_cast<int32_t>(offsetof(HelpURLAttribute_t4287019800, ___m_Url_0)); }
