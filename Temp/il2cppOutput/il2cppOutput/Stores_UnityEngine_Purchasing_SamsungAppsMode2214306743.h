...
struct  SamsungAppsMode_t2214306743 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SamsungAppsMode_t2214306743, ___value___1)); }
