...
struct  RestoreTransactionIDState_t2487303652 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RestoreTransactionIDState_t2487303652, ___value___1)); }
