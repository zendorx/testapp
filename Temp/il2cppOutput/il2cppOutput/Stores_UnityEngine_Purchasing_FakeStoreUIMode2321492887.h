...
struct  FakeStoreUIMode_t2321492887 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FakeStoreUIMode_t2321492887, ___value___1)); }
