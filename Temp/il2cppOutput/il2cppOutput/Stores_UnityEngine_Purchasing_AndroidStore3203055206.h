...
struct  AndroidStore_t3203055206 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AndroidStore_t3203055206, ___value___1)); }
