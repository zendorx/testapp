...
struct  TradeSeqState_t1177537792 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TradeSeqState_t1177537792, ___value___1)); }
